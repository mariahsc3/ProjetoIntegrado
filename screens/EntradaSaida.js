...
export default function EntradaSaida({navigation}) {
  ...
  return (
    <View style={styles.container}>
      <ScrollView>
        ...
        <Text style={styles.sub}>Entrada/Saída de itens:</Text>
        <Text style={styles.text}>Nome do item</Text>
        <View style={styles.card}>
            <TextInput style={styles.campo}>ex: Copo 500ml</TextInput>
        </View>
        <Text style={styles.text}>Código</Text>
        <View style={styles.card}>
            <TextInput style={styles.campo}>xxxxxx</TextInput>
        </View>
        ...
        <View style={styles.card}>
            <TextInput style={styles.campo}>xx</TextInput>
        </View>
